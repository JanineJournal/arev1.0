...
{
    /**
     * Lists all parametre entities + les périphériques infos repris de CORRESPONDANCE ELIXIR.
    ...
    public function indexAction()
    {
        ...
        $infosPeriphs = $em->getRepository('AppBundle:InfosPeriph')->findAll();

        return $this->render('parametre/index.html.twig', array(
            'parametre' => $parametre,
            'infosPeriphs' => $infosPeriphs,
        ));
    }
